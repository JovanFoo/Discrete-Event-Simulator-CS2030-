...
public class ImList<E> implements Iterable<E> {
    ...
    /**
     * Compares the specified object with this immutable list for equality.
     * Returns {@code true} if and only if the specified object is also an
     * immutable list having the same size, and all corresponding pairs of
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            return true;
        } else if (obj instanceof ImList<?> otherList) {
            return this.elems.equals(otherList.elems);
        } else {
            return false;
        }
    }
    ...
    /**
     * Returns a sequential {@code Stream} with this immutable list as its source.
     *
     * @return a sequential {@code Stream} over the elements in this immutable list
     * @since 1.8
     */
